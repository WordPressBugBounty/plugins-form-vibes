...
if ( !class_exists( 'FormVibes\\Plugin' ) ) {
    class Plugin {
        ...
        public function admin_scripts() {
            ...
            wp_enqueue_style(
                'fv-index-css',
                WPV_FV__URL . 'assets/dist/css/index.css',
                [],
                WPV_FV__VERSION
            );
            wp_enqueue_style(
                'fv-admin-dp',
                WPV_FV__URL . 'assets/dist/css/date-picker.css',
                [],
                WPV_FV__VERSION
            );
            wp_enqueue_script(
            ...
            wp_enqueue_script(
                'fv-sub-js',
                WPV_FV__URL . 'assets/dist/js/submission.js',
                [],
                WPV_FV__VERSION,
                true
            );
        ...
        private function load_settings_scripts() {
            wp_enqueue_script(
                'setting-js',
                WPV_FV__URL . 'assets/dist/js/settings.js',
                [],
                WPV_FV__VERSION,
                true
            );
            wp_enqueue_style(
                'setting-css',
                WPV_FV__URL . 'assets/dist/css/settings.css',
                '',
                WPV_FV__VERSION
            );
        }
        ...
        public function settings_link( $links ) {
            ...
            $settings_link = '<a class="fv-go-pro-menu" href="' . esc_url( $url ) . '">Settings</a>';
