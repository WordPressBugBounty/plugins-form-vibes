...
class Module {
	...
	public function admin_scripts() {
		...
		if ( 'form-vibes_page_fv-analytics' === $screen->id ) {
			wp_enqueue_script( 'analytics-js', WPV_FV__URL . 'assets/dist/js/analytics.js', [ 'wp-components' ], WPV_FV__VERSION, true );
			wp_enqueue_style( 'analytics-css', WPV_FV__URL . 'assets/dist/css/analytics.css', '', WPV_FV__VERSION );
